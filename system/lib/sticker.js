...
async function imageToWebp(media) {
   const tmpFileOut = path.join(process.cwd(), "system/temp/tmp", `${Crypto.randomBytes(6).readUIntLE(0, 6).toString(36)}.webp`)
   const tmpFileIn = path.join(process.cwd(), "system/temp/tmp", `${Crypto.randomBytes(6).readUIntLE(0, 6).toString(36)}.jpg`)
...
async function videoToWebp(media) {
   const tmpFileOut = path.join(process.cwd(), "system/temp/tmp", `${Crypto.randomBytes(6).readUIntLE(0, 6).toString(36)}.webp`)
   const tmpFileIn = path.join(process.cwd(), "system/temp/tmp", `${Crypto.randomBytes(6).readUIntLE(0, 6).toString(36)}.mp4`)
...
async function writeExif(media, metadata) {
   ...
   const tmpFileOut = path.join(process.cwd(), "system/temp/tmp", `${Crypto.randomBytes(6).readUIntLE(0, 6).toString(36)}.webp`)
   const tmpFileIn = path.join(process.cwd(), "system/temp/tmp", `${Crypto.randomBytes(6).readUIntLE(0, 6).toString(30)}.webp`)
...
module.exports = { imageToWebp, videoToWebp, writeExif, webp2mp4File };